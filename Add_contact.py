...
class AddContact(QWidget):
    def __init__(self) -> None:
        ...
        self.year = QComboBox()
        self.year.addItems(str(i) for i in range(1950,2010))
    ...
    def Save_contact(self): 
        db = DBHandler()
        day = int(self.day.itemText())
        month = int(self.month.itemText())
        year = int(self.year.itemText())
        first = self.first.text()
        last = self.last.text()
        gender = self.gender.itemText()
